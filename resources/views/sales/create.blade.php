            ...
            <form action="{{ route('sales.store') }}" method="POST" id="sales-pos-form" class="prevent-multi-submit">
                ...
                <div class="flex flex-wrap w-full">
                                ...
                                <div class="flex flex-wrap -mx-2">
                                    ...
                                    <div class="w-3/12 px-2">
                                        ...
                                        <input type="text" name="kode_nota"
                                            ...
                                            value="{{ old('kode_nota', $defaultKodeNota ?? '') }}" required disabled>
                                        @error('kode_nota')
                                    ...
                                    <div class="w-3/12 px-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button type="button" class="btn btn-outline-primary" id="btn-open-scanner">
                                                <i class="fas fa-camera"></i>
                                            </button>
                                        </div>
                                        <small class="text-muted">
                                            Scan barcode untuk menambah produk otomatis
                                        </small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="space-y-3">
                                    <div>
                                        ...
                                        <input type="text" id="total-display" class="form-control" value="Rp 0"
                                            readonly>
                    ...
                    <div class="w-2/12 px-2">
                        ...
                        <div id="scanner-card" class="card border-0 shadow-sm mb-3 d-none">
                            <div class="card-header flex justify-between items-center">
                                <h6 class="mb-0">Scan Barcode Produk</h6>
                                <button type="button" class="btn btn-sm btn-outline-secondary" id="btn-close-scanner">
                                    Tutup Scanner
                                </button>
                            </div>
                        ...
                        <div class="card border-0 shadow-sm mb-3">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <input type="number" id="qty-input" class="form-control form-control-sm"
                                        placeholder="Qty" min="1" value="1" style="width: 80px;">
...
{{-- JS Scanner untuk POS --}}
<script src="{{ asset('js/pos_scanner.js') }}"></script>
@endsection