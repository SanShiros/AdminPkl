                ...
                <div class="card-body">
                    <form action="{{ route('products.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="id_supplier_default" class="form-select">
                                ...
                                @foreach ($suppliers as $supplier)
                                    <option value="{{ $supplier->id }}" {{ old('id_supplier_default') == $supplier->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="stok" class="form-control" min="0" value="{{ old('stok', 0) }}" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Harga Beli Terakhir</label>
                            <input type="number" step="0.01" name="harga_beli_terakhir" class="form-control" value="{{ old('harga_beli_terakhir') }}">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Harga Jual</label>
                            <input type="number" step="0.01" name="harga_jual" class="form-control" value="{{ old('harga_jual') }}" required>
                        </div>
