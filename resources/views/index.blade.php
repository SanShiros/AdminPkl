  ...
  <div class="navbar-wrapper">
    ...
    <div class="navbar-content h-[calc(100vh_-_74px)] py-2.5">
      <ul class="pc-navbar">
        ...
        <li class="pc-item pc-hasmenu">
          <a href="{{ route('typografi') }}" class="pc-link">
                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    <tbody>
                      <tr class="unread">
                        <td>
                          <img class="rounded-full max-w-10" style="width: 40px" src="/images/user/avatar-1.jpg" alt="activity-user" />
                        </td>
                        <td>
                      ...
                      <tr class="unread">
                        <td>
                          <img class="rounded-full max-w-10" style="width: 40px" src="/images/user/avatar-2.jpg" alt="activity-user" />
                        </td>
                        <td>
                      ...
                      <tr class="unread">
                        <td>
                          <img class="rounded-full max-w-10" style="width: 40px" src="/images/user/avatar-3.jpg" alt="activity-user" />
                        </td>
                        <td>
